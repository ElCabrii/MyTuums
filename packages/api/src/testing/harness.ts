...
export async function truncateAll(): Promise<void> {
  assertTestDatabase();
  await db.execute(
    sql`TRUNCATE TABLE "post_like", "post_repost", "post_bookmark", "follow", "report", "user_block", "appeal", "moderation_action", "post", "session", "account", "verification", "rate_limit", "two_factor", "passkey", "user" RESTART IDENTITY CASCADE`,
  );
}
