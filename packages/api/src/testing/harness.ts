...
export async function truncateAll(): Promise<void> {
  ...
  await runSql(
    db,
    sql`TRUNCATE TABLE "post_like", "post_repost", "post_bookmark", "post_edit", "follow", "report", "user_block", "appeal", "moderation_action", "notification", "notification_last_seen", "post", "link_card", "game_favorite", "game", "feed_rank_snapshot", "session", "account", "verification", "rate_limit", "two_factor", "passkey", "user" RESTART IDENTITY CASCADE`,
  );
}
