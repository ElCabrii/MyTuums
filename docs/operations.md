...
curl -H "Host: home.mytuums.com" http://localhost:3001/
```
...
**The branding site rides the app's deployment.** `home.mytuums.com` is
...
`home.mytuums.com` as a custom domain on the production service, then create
